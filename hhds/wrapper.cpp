...
void tree_int_free(TreeIntHandle tree) { delete static_cast<TreeInt*>(tree); }
...
hhds::Tree_pos get_root(TreeIntHandle tree_handle) { return static_cast<TreeInt*>(tree_handle)->get_root(); }
...
hhds::Tree_pos add_root(TreeIntHandle tree, int data) { return static_cast<TreeInt*>(tree)->add_root(data); }
void delete_leaf(TreeIntHandle tree, hhds::Tree_pos leaf_index) { return static_cast<TreeInt*>(tree)->delete_leaf(leaf_index); }
...
// Tree Data Access
int  tree_get_data(TreeIntHandle tree_handle, hhds::Tree_pos idx) { return static_cast<TreeInt*>(tree_handle)->get_data(idx); }
void tree_set_data(TreeIntHandle tree, hhds::Tree_pos idx, int data) { return static_cast<TreeInt*>(tree)->set_data(idx, data); }
void print_tree(TreeIntHandle tree, int deep) { return static_cast<TreeInt*>(tree)->print_tree(deep); }

// --- Forest ---

ForestIntHandle forest_int_new() { return new ForestInt(); }

void forest_int_free(ForestIntHandle forest) { delete static_cast<ForestInt*>(forest); }
...
void forest_int_add_ref(ForestIntHandle forest, hhds::Tree_pos ref) { return static_cast<ForestInt*>(forest)->add_reference(ref); }
