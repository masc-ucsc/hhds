...
#define HHDS_CHIP_LONG_CASE(depth)                      \
...
HHDS_CHIP_LONG_CASE(1)
HHDS_CHIP_LONG_CASE(2)
HHDS_CHIP_LONG_CASE(3)
HHDS_CHIP_LONG_CASE(4)
HHDS_CHIP_LONG_CASE(5)
HHDS_CHIP_LONG_CASE(6)
HHDS_CHIP_LONG_CASE(7)
HHDS_CHIP_LONG_CASE(8)
