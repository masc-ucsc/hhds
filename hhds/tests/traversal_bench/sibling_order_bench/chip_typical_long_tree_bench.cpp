...
BENCHMARK(test_chip_typical_tree_7_hhds)->Iterations(4);
BENCHMARK(test_chip_typical_tree_7_lh)->Iterations(4);
BENCHMARK(test_chip_typical_tree_8_hhds)->Iterations(2);
BENCHMARK(test_chip_typical_tree_8_lh)->Iterations(2);
